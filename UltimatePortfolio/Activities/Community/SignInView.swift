...
//  UltimatePortfolio
//
//  Created by Andrey Mikhaylin on 29.09.2021.
//
            ...
            Group {
                ...
                case .unknown:
                    VStack(alignment: .leading) {
                        ScrollView {
                            Text("""
                                In order to keep our community safe, we ask \
                                that you sign in before commenting on a project.

                                We don't track your personal information; your name is used only for display purposes.

                                Please note: we reserve the right to remove \
                                messages that are inappropriate or offensive.
                                """)
                        }
